<html>
	<head>
		...
		<?php 
			...
			$arr = array('PK_id','color_id','door_type','CarName','ColorName','DoorName','Image Name','Image');
			$arr1 = array('PK_id','FK_color_id','FK_doorType','CarName','ColorName','DoorName','image');
			
			$obj1->Draw_Table_Search_Order(4,false,$arr,$query2,$arr1);
